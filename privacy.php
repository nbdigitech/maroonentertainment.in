			...
			<div class="container">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 align-center about_video_anim1">
						<div class="intro">
							<h3 style="color:black;">Privacy Policies </h3>
							<p style="color: black;">
							
							
							This page is used to inform website/app visitors regarding upcoming concerts and book tickets my policies with the collection, use, and disclosure of Personal Information if anyone decided to use my Service.
If you choose to use my Service, then you agree to the collection and use of information in relation to this policy. The Personal Information that I collect is used for providing and improving the Service. I will not use or share your information with anyone except as described in this Privacy Policy.
The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Shopbook unless otherwise defined in this Privacy Policy.
Information Collection and Use
For a better experience, while using our Service, I may require you to provide us with certain personally identifiable information, including but not limited to location,READ_PHONE_STATE,internet. The information that I request is retained on your device and is not collected by me in any way
...
I may update our Privacy Policy from time to time. Thus, you are advised to review this page periodically for any changes. I will notify you of any changes by posting the new Privacy Policy on this page. These changes are effective immediately after they are posted on this page.
							...
							<p style="color: black;">
							<h5>Contact Us </h5>
							If you have any questions or suggestions about my Privacy Policy, do not hesitate to </br >contact us  info@maroonentertainment.in
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 align-center about_video_anim3">
						<div class="feature_content">
							...
							<a href="privacy.html" class="" ><h6 style="color:black;">Privacy Policies</h6></a>
					...
					<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 align-center about_video_anim4">
						<div class="feature_content">
							<div data-icon="&#xe1cf;" class="iconbox_icon icon_rounded"></div>
							<a href="refunds.html" class="" ><h6 style="color:black;">Refunds</h6></a>
					...
					<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 align-center about_video_anim5">
						<div class="feature_content">
							<div data-icon="&#xe08e;" class="iconbox_icon icon_rounded"></div>
							<a href="terms.html" class="" ><h6 style="color:black;">Terms Of Services</h6></a>
...
<style>
 ...
 <img src="images/logo_home.png" alt="logo" class="logo_home"  width="180px" height="150px" />
					...
					<p>Copyright © 2017 Maroon Entertainment Pvt. Ltd.</p>	
					</div>
				</div>				
			</div>
		</section>
