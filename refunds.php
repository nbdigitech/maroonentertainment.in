			...
			<div class="container">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 align-center about_video_anim1">
						<div class="intro">
							<h3 style="color:black;">Refunds Policy </h3>
							
							<p style="color: black;">
							<h5 > Returns</h5>
We take Returns requests Prior to one month of any concert if u have booked early bird tickets and wants to return before a month u can mail us at info@maroonentertainment.in
							</p>
