		...
		<div class="" style="overflow-x:auto;">
			...
			<div class="rdiv1">
				...
				<?php 
					...
					$query =mysqli_query($conn,"select * from tktbooking order by 1 DESC");
			...
			?>
				<div class="rdiv11">
					...
					<div class="rdiv12" id="rdiv55">
						<center><a href='enquiry_info.php?edit=<?php echo $id; ?>,<?php echo $purpose; ?>,<?php echo $name; ?>,<?php echo $email; ?>,<?php echo $mobile; ?>,<?php echo $price; ?>,<?php echo $quantity; ?>,<?php echo $total_amount; ?>,<?php echo $date; ?>' class="btn btn-primary" id="p"><i class="fa fa-eye" aria-hidden="true" id="ii"></i></a>
