...
<div class="panel-body">
		...
		<form action="edit_enquiry_info.php?edit_form=<?php echo "$split_val[0]"; ?>" method="post" enctype="multipart/form-data">
			...
			<div>
			   ...
			   <input type="text" name="" class="widthDiv" value="<?php echo "$split_val[2]"; ?>">
			</div>
			<div>
			   <strong>EMAIL</strong><br>
			   <input type="text" name="" class="widthDiv" value="<?php echo "$split_val[3]"; ?>">
			</div>
			<div>
			...
			<div>
			   ...
			   <input type="text" name="" class="widthDiv" value="<?php echo "$split_val[5]"; ?>">
			</div>
			<div>
			   <strong>QUANTITY</strong><br>
			   <input type="text" name="" class="widthDiv" value="<?php echo "$split_val[6]"; ?>">
			</div>
			<div>
			   <strong>TOTAL AMOUNT</strong><br>
			   <input type="text" name="" class="widthDiv" value="<?php echo "$split_val[7]"; ?>">
			</div>
			<div>
			   <strong>DATE</strong><br>
			   <input type="text" name="" class="widthDiv" value="<?php echo "$split_val[8]"; ?>">
			</div>

			
			
			<a href="view_tktbookin_info.php" class="btn btn-primary">Back</a>
		</form>
