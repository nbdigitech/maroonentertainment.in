		...
		<div class="" style="overflow-x:auto;">
			...
			<div class="rdiv1">
				...
				<?php
					...
					$query =mysqli_query($mysqli,"select * from gallery_info order by 1 DESC");
			...
			?>
				<div class="rdiv11">
					...
					<div class="rdiv12" id="rdiv55">
						<center><a href='edit_gal_info.php?edit=<?php echo $id; ?>,<?php echo $gal_image; ?>,<?php echo $title; ?>,<?php echo $category; ?>,<?php echo $date; ?>' class="btn btn-primary" id="p"><i class="fa fa-eye" aria-hidden="true" id="ii"></i></a>
		<a href='delete_gal_info.php?del=<?php echo $id; ?>' class="btn btn-danger" id="p"><i class="fa fa-trash" aria-hidden="true" id="ii"></i></a></center>
					</div>
