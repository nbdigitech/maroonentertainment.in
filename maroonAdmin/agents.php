		...
		<div class="containerBody">
			<div class="dsbrd">
				...
				<div class="viewAgents">
				  	...
				  	<center><h4 style="color: red;">AGENTS LIST</h4></center>
				  	
				  	<div class="rdiv1"><div id="agnt">
				...
				<?php 
					...
					$query =mysqli_query($conn,"select * from agents order by 1 DESC");
			...
			?>
				<div class="rdiv11">
					...
					<div class="rdiv12" id="rdiv33">
						<?php echo $agentMobile; ?>
					</div>
					<div class="rdiv12" id="rdiv44">
						<center><a href='full_agentDet.php?agntView=<?php echo $id; ?>,<?php echo $agentName; ?>,<?php echo $agentEmail; ?>,<?php echo $agentMobile; ?>,<?php echo $agentBusiness; ?>,<?php echo $agentAddress; ?>,<?php echo $agentArea; ?>,<?php echo $agentCity; ?>,<?php echo $agentId; ?>,<?php echo $agentStatus; ?>,<?php echo $agentDate; ?>' class="fa-lg" id="fA"><i class="fa fa-eye btn btn-primary " aria-hidden="true" id="ii"></i></a>

		<a href="includes/agentDel.php?aid=<?php echo $id; ?>" class="fa-lg" id="agnDel"><i class="fa fa-trash btn btn-danger" aria-hidden="true" id="ii"></i></a></center>
					</div>
					<input type="hidden" name="delA" value="<?php echo $id; ?>" id="delA">
