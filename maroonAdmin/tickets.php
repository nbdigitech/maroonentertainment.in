...
echo "<style> #agnt{display:none}</style>";
}
else{
...
<div id='hideMenu'>
	<?php 
	    if(isset($_SESSION['sess_admin'])){echo $adminh;}
	    else{echo $userh;}
			...
			<div class="dsbrd">
				...
				<div class="viewAgents">
				  	...
				  	<div class="rdiv1">
				  		...
				  		<center><div><input type="text" name="searchTktSale" id="searchTktSale" placeholder="Search by Agent ID or Ticket No. or User Mobile No."></div></center>
				  		<div id="reasult"></div>
